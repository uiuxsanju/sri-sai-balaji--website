...
export const categories: Category[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Andhra pickles in Vijayawada — veg, lemon, mango, usirikaya, pandu mirchi, allam, gongura, tomato, chicken, prawns and mutton — made to traditional recipes. WhatsApp us for jar sizes and price.",
    ...
    intro: [
      ...
      "Eleven varieties: mixed vegetable, lemon, mango, usirikaya, pandu mirchi, allam, gongura and tomato pickles, alongside three non-vegetarian pickles — chicken, prawns and mutton.",
    ],
    ...
    faqs: [
      {
        ...
        a: "Veg pickle, lemon pickle, mango pickle, usirikaya (amla) pickle, pandu mirchi (ripe chilli) pickle, allam (ginger) pickle, gongura pickle, tomato pickle, chicken pickle, prawns pickle and mutton pickle.",
      },
      {
...
export const products: Product[] = [
  ...
  },
  {
    ...
    displayName: "Andhra Lemon Pickle",
    category: "andhra-pickles",
    image: "lemon-pickle",
    imageAlt: "Traditional Andhra lemon pickle jar in Vijayawada",
    seoTitle:
      "Andhra Lemon Pickle in Vijayawada | Traditional Nimmakaya Pachadi",
    metaDescription:
      "Traditional Andhra lemon pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Lemon Pickle",
    short: "Whole lemon pieces pickled in a hot, tangy traditional Andhra masala.",
    description: [
      "Lemons cut and salted, then simmered down in a hot, tangy masala until the peel softens and takes on the spice — the nimmakaya pachadi Andhra kitchens keep on hand through the year.",
      "Its sharp, tangy heat works well with curd rice, plain rice and ghee, or as a side with idli and dosa.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Whole lemon pieces in a tangy masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "lemon pickle Vijayawada",
      "nimmakaya pachadi",
      "Andhra lemon pickle",
      "traditional lemon pickle Vijayawada",
    ],
  },
  {
    slug: "mango-pickle",
    name: "Mango Pickle",
    teluguName: "మామిడికాయ పచ్చడి",
    displayName: "Andhra Mango Pickle",
    category: "andhra-pickles",
    image: "mango-pickle",
    imageAlt: "Traditional Andhra mango pickle jar in Vijayawada",
    seoTitle:
      "Andhra Mango Pickle in Vijayawada | Traditional Mamidikaya Pachadi",
    metaDescription:
      "Traditional Andhra raw mango pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Mango Pickle",
    short: "Raw mango pickle cut and spiced to a traditional Andhra recipe.",
    description: [
      "Raw mango cut into pieces, salted and mixed with freshly ground pickle masala — the mamidikaya pachadi that anchors an Andhra pickle shelf.",
      "Eaten with rice and ghee, curd rice, or alongside idli and dosa.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Raw mango in freshly ground masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "mango pickle Vijayawada",
      "mamidikaya pachadi",
      "raw mango pickle Andhra",
      "traditional mango pickle Vijayawada",
    ],
  },
  {
    ...
    displayName: "Andhra Usirikaya Pickle",
    category: "andhra-pickles",
    image: "usirikaya-pickle",
    imageAlt: "Traditional Andhra usirikaya (amla) pickle jar in Vijayawada",
    seoTitle:
      "Andhra Usirikaya Pickle in Vijayawada | Traditional Amla Pickle",
    metaDescription:
      "Traditional Andhra usirikaya (amla) pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Usirikaya Pickle",
    short: "Amla (usirikaya) pickled whole in a traditional Andhra masala.",
    description: [
      "Whole gooseberries (usirikaya) cooked down in pickle masala until they soften and take on the spice, packed under oil in the traditional way.",
      "Eaten with rice and ghee or curd rice, the way it is served at home.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Whole amla in traditional masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "usirikaya pickle Vijayawada",
      "amla pickle Andhra",
      "gooseberry pickle Vijayawada",
      "usirikaya pachadi",
    ],
  },
  {
    ...
    teluguName: "పండు మిర్చి పచ్చడి",
    displayName: "Andhra Pandu Mirchi Pickle",
    category: "andhra-pickles",
    image: "pandu-mirchi-pickle",
    imageAlt: "Traditional Andhra pandu mirchi (ripe chilli) pickle jar in Vijayawada",
    seoTitle:
      "Andhra Pandu Mirchi Pickle in Vijayawada | Traditional Ripe Chilli Pickle",
    metaDescription:
      "Traditional Andhra pandu mirchi (ripe chilli) pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Pandu Mirchi Pickle",
    short: "Ripe chilli (pandu mirchi) pickle in a traditional Andhra masala.",
    description: [
      "Ripe chillies pickled whole in a traditional masala — a sharper, hotter pickle for those who want the extra heat.",
      "A small spoon goes a long way alongside rice, curd rice or any meal that needs extra heat.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Whole ripe chillies in masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "pandu mirchi pickle Vijayawada",
      "ripe chilli pickle Andhra",
      "mirchi pachadi Vijayawada",
      "spicy chilli pickle Vijayawada",
    ],
  },
  {
    slug: "allam-pickle",
    ...
    displayName: "Andhra Allam Pickle",
    category: "andhra-pickles",
    image: "allam-pickle",
    imageAlt: "Traditional Andhra allam (ginger) pickle jar in Vijayawada",
    seoTitle: "Andhra Allam Pickle in Vijayawada | Traditional Ginger Pickle",
    metaDescription:
      "Traditional Andhra allam (ginger) pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Allam Pickle",
    short: "Ginger (allam) pickle cooked down in a tangy traditional masala.",
    description: [
      "Fresh ginger cut and cooked down slowly with tamarind and pickle masala until it turns deep and glossy — allam pachadi in the traditional style.",
      "Its warm, tangy heat pairs well with curd rice, dosa, idli and upma.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Ginger cooked down in tangy masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "allam pickle Vijayawada",
      "ginger pickle Andhra",
      "allam pachadi Vijayawada",
      "traditional ginger pickle Vijayawada",
    ],
  },
  {
    slug: "gongura-pickle",
    ...
    displayName: "Andhra Gongura Pickle",
    category: "andhra-pickles",
    image: "gongura-pickle",
    imageAlt: "Traditional Andhra gongura pickle jar in Vijayawada",
    seoTitle: "Andhra Gongura Pickle in Vijayawada | Traditional Gongura Pachadi",
    metaDescription:
      "Traditional Andhra gongura pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Gongura Pickle",
    short: "Gongura leaves cooked down into the classic tangy Andhra pickle.",
    description: [
      "Gongura (sorrel) leaves cooked down slowly with pickle masala until they turn thick and deep green — the tangy pickle most associated with Andhra kitchens.",
      "Eaten with hot rice and ghee, or mixed through curd rice.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Gongura leaves in traditional masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "gongura pickle Vijayawada",
      "gongura pachadi",
      "sorrel leaves pickle Andhra",
      "traditional gongura pickle Vijayawada",
    ],
  },
  {
    slug: "tomato-pickle",
    ...
    displayName: "Andhra Tomato Pickle",
    category: "andhra-pickles",
    image: "tomato-pickle",
    imageAlt: "Traditional Andhra tomato pickle jar in Vijayawada",
    seoTitle: "Andhra Tomato Pickle in Vijayawada | Traditional Tomato Pachadi",
    metaDescription:
      "Traditional Andhra tomato pickle made to a home recipe, packed in glass jars. Available in Vijayawada — WhatsApp for sizes and price.",
    h1: "Andhra Tomato Pickle",
    short: "Tomato pickle cooked down in a traditional Andhra masala.",
    description: [
      "Tomatoes cooked down slowly with pickle masala until they thicken into a deep red pickle — an easy, everyday pachadi for a kitchen that always needs one jar open.",
      "Eaten with rice, curd rice, idli, dosa or roti.",
    ],
    features: [
      "Traditional Andhra home recipe",
      "Tomatoes cooked down in traditional masala",
      "Packed in glass jars",
      "500 g and 1 kg jars",
    ],
    sizes: ["500 g", "1 kg"],
    keywords: [
      "tomato pickle Vijayawada",
      "tomato pachadi Andhra",
      "traditional tomato pickle Vijayawada",
      "tomato pickle Andhra Pradesh",
    ],
  },
  {
    slug: "chicken-pickle",
